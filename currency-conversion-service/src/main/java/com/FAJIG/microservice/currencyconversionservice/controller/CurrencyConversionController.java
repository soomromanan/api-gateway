package com.FAJIG.microservice.currencyconversionservice.controller;

import com.FAJIG.microservice.currencyconversionservice.bean.CurrencyConversion;
import com.FAJIG.microservice.currencyconversionservice.proxy.CurrencyExchangeProxy;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversion(@PathVariable String from,
        ...
        HashMap<String,String> uirVarialbles = new HashMap<>();
        uirVarialbles.put("from",from);
        uirVarialbles.put("to",to);
        ResponseEntity<CurrencyConversion> responseEntity =
        new RestTemplate().getForEntity("http://localhost:8000/currency-exchange/from/{from}/to/{to}",CurrencyConversion.class,uirVarialbles);
